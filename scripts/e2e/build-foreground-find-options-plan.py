...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build the bounded real-App Find option-composition plan."
    )
...
def find_option_actions(raw_dir: pathlib.Path) -> list[dict[str, object]]:
    return [
        ...
        {"kind": "text", "text": "Red red redwood RED", "waitMs": 80},
        ...
        },
        {
            ...
            "path": str(raw_dir / "find-options-composed.png"),
            "waitMs": 40,
        },
    ]
...
def main() -> None:
    ...
    write_atomic_json(
        {"schemaVersion": 1, "actions": find_option_actions(raw_dir)},
