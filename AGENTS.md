...
- **Session restore**: on relaunch it reopens the previous tabs (including unsaved edits), the active tab, font size, sidebar width, and each tab's scroll position.
