...
struct InlineTests {
    ...
    @Test func bold() {
        ...
        let b = StylerProbe.index(of: "b", in: ts)      // idx 4
    ...
    @Test func strikethrough() {
        ...
        let y = StylerProbe.index(of: "y", in: ts)      // idx 2
    ...
    @Test func inlineCode() {
        ...
        let c = StylerProbe.index(of: "code", in: ts)   // idx 3
    ...
    @Test func link() {
        ...
        let label = StylerProbe.range(of: "label", in: ts)   // idx 1..5
        ...
        let url = StylerProbe.range(of: "http://x", in: ts)
    ...
    @Test func image() {
        ...
        let alt = StylerProbe.range(of: "alt", in: ts)
        let a = alt.location
